...
if (plus != 0){
	average = (avgStarter+avgBasic+avgInter+avgJoy+avgAdvanced+avgUpper+avgPlus+avgUnit)/8;
	average = average.toFixed(2);
}else{
	average = (avgStarter+avgBasic+avgInter+avgJoy+avgAdvanced+avgUpper+avgUnit)/7;
	average = average.toFixed(2);
}
